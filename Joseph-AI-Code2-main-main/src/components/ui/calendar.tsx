  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-1 flex items-center justify-between w-full absolute left-0 right-0 top-0",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 cursor-pointer z-10",
        ),
